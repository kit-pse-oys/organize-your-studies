 ...
 *
 * TODO: Heißt aktuell FreeTimeDTO2, weil FreeTimeDTO gerade noch anders belegt ist.
 * Sobald das bereinigt ist: Datei + Klasse auf "FreeTimeDTO" umbenennen per Rename.
 *
...
public class FreeTimeDTO2 {
     ...
     */
    public FreeTimeDTO2(UUID id, String title, LocalDate date, LocalTime startTime, LocalTime endTime, boolean weekly) {
        this.id = id;
        this.title = title;
        this.date = date;
